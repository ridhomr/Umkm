...
def my_profile_view(request):
    ...
    return render(request,'dashboard/my_profile.html',{'customer':customer})
...
def edit_profile_view(request):
    ...
    return render(request,'dashboard/edit_profile.html',context=mydict)
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if contactForm.is_valid():
            contactForm.save()
            return render(request, 'ecom/contact_sent.html')
    return render(request, 'ecom/send_contact.html', {'contactForm':contactForm})
...
def view_feedback_view(request):
    ...
    return render(request,'ecom/views-feedback.html',{'feedbacks':feedbacks})


@login_required(login_url='login')
def view_contact_view(request):
    contacts=models.Contact.objects.all().order_by('-id')
    return render(request,'ecom/views-contact.html',{'contacts':contacts})